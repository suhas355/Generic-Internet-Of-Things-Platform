...
public class Register extends ActionBarActivity {
    ...
    static HashMap<String,String> phn = new HashMap<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phn.put("1","+917661063895");
        phn.put("2","9999999999");
        phn.put("3","8888888888");
        phn.put("4","7777777777");
    ...
    class Notify extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://10.42.0.19:6300/monitor/getsensors");

...
public class MainActivity extends ActionBarActivity {
    ...
    private static final String macad = "84:51:BF:2C:8C:03";  // batman
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PingResponder prn = new PingResponder();
                FilterComm fc = new FilterComm();
    ...
    private class Initializer extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... params) {
            ...
            String messageStr="84:51:BF:2C:8C:03";   // batman
            ...
            try {
                local = InetAddress.getByName("192.168.217.106");   // batman
    ...
    private class FilterComm extends AsyncTask<String, String, String>{
        ...
        public static final String SERVERIP = "192.168.217.106";  // batman
